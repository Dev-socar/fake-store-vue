...
<template>
  <div
    class="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl p-3"
  >
    ...
    <div class="flex flex-col md:flex-row gap-3">
      <button
        class="w-full p-3 bg-purple-700 text-white rounded text-center text-sm md:text-base uppercase hover:bg-purple-600 transition-colors duration-300"
      >
        Add Cart
      </button>
    </div>
